...
var page = 1;
var listNum = 3;
var generalPage = Math.ceil(todayPhoto.length / listNum);
var wrap = document.getElementById('wrap');
var pageEl = document.querySelector('.page');
var generalPageEl  =document.querySelector('.generalPage');
...
function printImg(page){
    ...
    wrap.innerHTML = str;
    page.innerHTML = page;
    generalPage.innerHTML = generalPage;
}
